...
namespace DSP_Battle
{
    public class UIRank
    {
        ...
        public static void InitUI()
        {
            ...
            rankObj.transform.localPosition = new Vector3(DSPGame.globalOption.resolution.width * 1.0f * Utils.UIActualHeight / DSPGame.globalOption.resolution.height / 2 - 80, Utils.UIActualHeight / 2 - 120);
